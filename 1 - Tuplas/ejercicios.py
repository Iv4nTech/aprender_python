"""
================================================================================
 EJERCICIOS DE TUPLAS — casos reales (de fácil a experto)
================================================================================

Instrucciones:
  - Cada ejercicio tiene una función con `pass` que debes completar.
  - Debajo de cada función hay asserts que validan tu solución.
  - Ejecuta el fichero para comprobar tus respuestas:

        python3 ejercicios.py

    Primero verás QUÉ devuelve cada ejercicio (o el error si aún no está
    resuelto) y luego, si todo es correcto, "TODO CORRECTO" al final.
  - NO cambies las firmas de las funciones ni los asserts.
  - Las soluciones están en 'ejercicios_resueltos.py' (¡no mires antes!).
...
# ----------------------------------------------------------------------------
Empleado = None  # <- define aquí el namedtuple
...
def _run_tests():
    ...
    print("\n" + "=" * 60)
    print("  ✅  TODO CORRECTO — dominas las tuplas")
    print("=" * 60)
